...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-06-2025 a las 13:37:17
...
INSERT INTO `clientes` (`id`, `nombre`, `apellidos`, `dni`, `edad`, `telefono`, `correo`, `tiempo_suscripcion`, `direccion`, `id_sede`, `fecha`) VALUES
(1, 'Pepito', 'Zapata', '12345678', 23, '987654321', 'pepito@gmail.com', '7 meses', 'mz a lt a', 1, '2025-06-30');
...
CREATE TABLE `usuarios` (
  ...
  `rol` enum('GERENTE_GENERAL','PRESIDENTE_FUNDADOR','GERENTE_OPRACIONES','OPERARIO','ENCARGADO','AYUDANTE','SEGURIDAD','LIMPIEZA','SUPERVISOR','CLIENTE') NOT NULL,
...
(1, 'Jairo', 'Perez', '7036214', '2004-06-12', 'Av. Lima 123', '999999999', 'jairo@example.com', '2025-06-09', 'PRESIDENTE_FUNDADOR', 'Mañana', 3000.00, 1, 1),
(2, 'Pepito', 'Zapata\r\n', '70836215', '1995-03-10', 'Av. Primavera 300', '900000001', 'lucia@example.com', '2025-06-09', 'AYUDANTE', 'Mañana', 1500.00, 1, 2),
(3, 'Carlos', 'Gómez', '70836216', '1988-07-22', 'Jr. Las Flores 123', '900000002', 'carlos@example.com', '2025-06-09', 'GERENTE_OPRACIONES', 'Tarde', 2200.00, 1, 3),
(4, 'María', 'Lopez', '70836217', '1992-05-14', 'Av. Javier Prado 456', '900000003', 'maria@example.com', '2025-06-09', 'SUPERVISOR', 'Mañana', 1200.00, 1, 2),
...
(6, 'Andrea', 'Salazar', '70836219', '1990-09-09', 'Av. Caminos del Inca 500', '900000005', 'andrea@example.com', '2025-06-09', 'OPERARIO', 'Tarde', 1500.00, 1, 4),
(7, 'Javier', 'Huamán', '70836220', '1994-02-18', 'Jr. San Martín 400', '900000006', 'javier@example.com', '2025-06-09', 'ENCARGADO', 'Mañana', 2100.00, 1, 5),
...
(10, 'Diana', 'Lopez', '70836223', '1993-06-06', 'Av. Colonial 567', '900000009', 'diana@example.com', '2025-06-09', 'GERENTE_OPRACIONES', 'Noche', 1550.00, 1, 5);
